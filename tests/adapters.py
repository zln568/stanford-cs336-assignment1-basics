...
def run_scaled_dot_product_attention(
    ...
    """
    return cs336_basics.transformer_lm.run_scaled_dot_product_attention(Q, K, V, mask)
...
def run_rope(
    ...
    """
    rope = cs336_basics.transformer_lm.RotaryPositionalEmbedding(theta, d_k, max_seq_len)
...
def run_softmax(in_features: Float[Tensor, " ..."], dim: int) -> Float[Tensor, " ..."]:
    ...
    """
    return cs336_basics.transformer_lm.run_softmax(in_features, dim)
...
def run_cross_entropy(
    ...
    """
    return cs336_basics.transformer_lm_trainer.run_cross_entropy(inputs, targets)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    return cs336_basics.transformer_lm_trainer.gradient_clipping(parameters, max_l2_norm)
...
def get_adamw_cls() -> Any:
    ...
    """
    return cs336_basics.transformer_lm_trainer.AdamW
...
def run_get_lr_cosine_schedule(
    ...
    """
    return cs336_basics.transformer_lm_trainer.get_lr_cosine_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
...
def get_tokenizer(
    ...
    """
    return cs336_basics.bpe_tokenizer.BPETokenizer(vocab, merges, special_tokens)
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return cs336_basics.bpe_trainer.train_bpe(input_path, vocab_size, special_tokens)